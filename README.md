...
[`v2026.09.25-linux`](https://github.com/Biaogo/foundation-sunshine-linux/releases/tag/v2026.09.25-linux)
tag tracks the `linux-support` fix series (currently
`b48a1cfb`: virtual-display routing under dual capture sources, ambient
